...
| P1 M1 | T03.2 migration implementation and PR #4 review fixes on `feat/p1-m1-migrations`; T15.2, T11.1, T11.3, and T17.1 remain open. | The [M1 result](p1/results.md) records a populated v1→v2 upgrade, SQLite recovery copy, fault rollback, linked database and altered-schema rejection, and locked Windows 11 x64 tests: 61 Core and 22 Infrastructure passes. Startup reconciliation is next. |
