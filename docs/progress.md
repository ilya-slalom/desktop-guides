...
| P1 M0 | Implemented in [PR #3](https://github.com/ilya-slalom/desktop-guides/pull/3) for review; not yet merged. | [M0 results](p1/results.md) record storage contracts/schema, managed path tests, typed reader contract, locator codecs, and the PDF decision. Windows 11 x64 PDF UIA/keyboard and app-specific outbound-blocked runs passed; [PR CI](p1/results.md#pr-ci-evidence) passed x64 and native ARM64 headless suites, both package builds, and the installed ARM64 P0 regression. |
