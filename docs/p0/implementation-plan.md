...
| T02.2 Native TXT probe | Done for P0 | Strict UTF-8 and explicit CP437, newline/whitespace tests, 10 MiB first-text and realized-item metrics, 17 sampled window responses during scrolling (4 ms maximum, no failures), exact restore after resize/font change and a tested edited-context fallback. |
